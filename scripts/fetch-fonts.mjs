...
const FAMILIES = [
	...
	/* --- Devanagari, extended shelf ------------------------------------------- */
	{
		...
		axes: [],
		devanagari: true,
		mood: 'calligraphic Devanagari with a brush edge',
		useFor: 'Nepali wedding, festival and invitation captions',
	},
	{
		slug: 'arya',
		family: 'Arya',
		...
		axes: [],
		devanagari: true,
		mood: 'low-contrast Devanagari sans',
		useFor: 'Nepali interface labels and short captions',
	},
	{
		slug: 'asar',
		family: 'Asar',
		source: 'asar',
		file: 'Asar-Regular.ttf',
		category: 'devanagari',
		weight: '400',
		axes: [],
		devanagari: true,
		mood: 'old-style Devanagari serif',
		useFor: 'literary Nepali quotes and book-style titles',
	},
	{
		slug: 'eczar',
		family: 'Eczar',
		...
		axes: ['wght'],
		devanagari: true,
		mood: 'sharp Devanagari with strong vertical stress',
		useFor: 'Nepali headlines and emphatic captions',
	},
	{
		slug: 'gotu',
		family: 'Gotu',
		source: 'gotu',
		file: 'Gotu-Regular.ttf',
		category: 'devanagari',
		weight: '400',
		axes: [],
		devanagari: true,
		mood: 'monolinear Devanagari, near-geometric',
		useFor: 'clean Nepali lower thirds and UI overlays',
	},
	{
		slug: 'glegoo',
		family: 'Glegoo',
		source: 'glegoo',
		file: 'Glegoo-Bold.ttf',
		category: 'devanagari',
		weight: '700',
		axes: [],
		devanagari: true,
		mood: 'slab-flavoured Devanagari serif',
		useFor: 'documentary Nepali subtitles',
	},
	{
		slug: 'jaini',
		family: 'Jaini',
		source: 'jaini',
		file: 'Jaini-Regular.ttf',
		category: 'devanagari',
		weight: '400',
		axes: [],
		devanagari: true,
		mood: 'decorative Devanagari display',
		useFor: 'Nepali poster hooks and title cards',
	},
	{
		slug: 'jaini-purva',
		family: 'Jaini Purva',
		source: 'jainipurva',
		file: 'JainiPurva-Regular.ttf',
		category: 'devanagari',
		weight: '400',
		axes: [],
		devanagari: true,
		mood: 'outlined decorative Devanagari',
		useFor: 'single-word Nepali hooks and stingers',
	},
	{
		slug: 'kadwa',
		family: 'Kadwa',
		...
		axes: [],
		devanagari: true,
		mood: 'firm Devanagari serif',
		useFor: 'Nepali news captions and interview lower thirds',
	},
	{
		slug: 'karma',
		family: 'Karma',
		...
		axes: [],
		devanagari: true,
		mood: 'readable Devanagari text face',
		useFor: 'long Nepali dialogue at small sizes',
	},
	{
		slug: 'khula',
		family: 'Khula',
		...
		axes: [],
		devanagari: true,
		mood: 'open Devanagari sans',
		useFor: 'general Nepali subtitles and captions',
	},
	{
		slug: 'kurale',
		family: 'Kurale',
		...
		axes: [],
		devanagari: true,
		mood: 'warm Devanagari serif with a calligraphic Latin',
		useFor: 'Nepali storytelling and vlog captions',
	},
	{
		slug: 'laila',
		family: 'Laila',
		...
		axes: [],
		devanagari: true,
		mood: 'compact Devanagari with short verticals',
		useFor: 'dense Nepali captions in vertical frames',
	},
	{
		slug: 'modak',
		family: 'Modak',
		source: 'modak',
		file: 'Modak-Regular.ttf',
		category: 'devanagari',
		weight: '400',
		axes: [],
		devanagari: true,
		mood: 'inflated Devanagari display, very heavy',
		useFor: 'Nepali meme captions and loud hooks',
	},
	{
		slug: 'rhodium-libre',
		family: 'Rhodium Libre',
		source: 'rhodiumlibre',
		file: 'RhodiumLibre-Regular.ttf',
		category: 'devanagari',
		weight: '400',
		axes: [],
		devanagari: true,
		mood: 'sturdy Devanagari serif with slab details',
		useFor: 'Nepali editorial titles',
	},
	{
		slug: 'sahitya',
		family: 'Sahitya',
		source: 'sahitya',
		file: 'Sahitya-Bold.ttf',
		category: 'devanagari',
		weight: '700',
		axes: [],
		devanagari: true,
		mood: 'traditional Devanagari serif',
		useFor: 'poetry, literature and Nepali documentary',
	},
	{
		slug: 'sarpanch',
		family: 'Sarpanch',
		source: 'sarpanch',
		file: 'Sarpanch-Bold.ttf',
		category: 'devanagari',
		weight: '700',
		axes: [],
		devanagari: true,
		mood: 'squared technical Devanagari',
		useFor: 'Nepali gaming, esports and tech captions',
	},
	{
		slug: 'sumana',
		family: 'Sumana',
		source: 'sumana',
		file: 'Sumana-Bold.ttf',
		category: 'devanagari',
		weight: '700',
		axes: [],
		devanagari: true,
		mood: 'light-contrast Devanagari serif',
		useFor: 'calm Nepali narration captions',
	},
	{
		slug: 'tillana',
		family: 'Tillana',
		source: 'tillana',
		file: 'Tillana-Bold.ttf',
		category: 'devanagari',
		weight: '700',
		axes: [],
		devanagari: true,
		mood: 'flowing Devanagari with dance-poster energy',
		useFor: 'Nepali music, festival and cultural edits',
	},
	{
		slug: 'vesper-libre',
		family: 'Vesper Libre',
		source: 'vesperlibre',
		file: 'VesperLibre-Bold.ttf',
		category: 'devanagari',
		weight: '700',
		axes: [],
		devanagari: true,
		mood: 'high-contrast Devanagari serif',
		useFor: 'Nepali film titles and credits',
	},
	{
		slug: 'yantramanav',
		family: 'Yantramanav',
		source: 'yantramanav',
		file: 'Yantramanav-Bold.ttf',
		category: 'devanagari',
		weight: '700',
		axes: [],
		devanagari: true,
		mood: 'engineered Devanagari grotesk',
		useFor: 'Nepali explainers, data and product videos',
	},
	{
		slug: 'rajdhani',
		family: 'Rajdhani',
		...
		axes: [],
		devanagari: true,
		mood: 'condensed squared Devanagari',
		useFor: 'Nepali sports scoreboards and HUD captions',
	},
	{
		slug: 'ek-mukta',
		family: 'Ek Mukta',
		source: 'ekmukta',
		file: 'EkMukta-Bold.ttf',
		category: 'devanagari',
		weight: '700',
		axes: [],
		devanagari: true,
		mood: 'the original Mukta cut, wider spacing',
		useFor: 'Nepali body captions when Mukta reads too tight',
	},
	{
		slug: 'ibm-plex-sans-devanagari',
		family: 'IBM Plex Sans Devanagari',
		source: 'ibmplexsansdevanagari',
		file: 'IBMPlexSansDevanagari-Bold.ttf',
		category: 'devanagari',
		weight: '700',
		axes: [],
		devanagari: true,
		mood: 'corporate-neutral Devanagari',
		useFor: 'Nepali corporate, training and product videos',
	},
	{
		slug: 'martel',
		family: 'Martel',
		source: 'martel',
		file: 'Martel-Bold.ttf',
		category: 'devanagari',
		weight: '700',
		axes: [],
		devanagari: true,
		mood: 'Devanagari serif companion to Martel Sans',
		useFor: 'Nepali long-form and interview subtitles',
	},
	{
		slug: 'jaldi',
		family: 'Jaldi',
		...
		axes: [],
		devanagari: true,
		mood: 'quick, open Devanagari sans',
		useFor: 'fast-cut Nepali social captions and reels',
	},
	{
		slug: 'pragati-narrow',
		family: 'Pragati Narrow',
		source: 'pragatinarrow',
		file: 'PragatiNarrow-Bold.ttf',
		category: 'devanagari',
		weight: '700',
		axes: [],
		devanagari: true,
		mood: 'narrow Devanagari built to save horizontal space',
		useFor: 'long Nepali lines that must fit one row',
	},
	{
		slug: 'dekko',
		family: 'Dekko',
		source: 'dekko',
		file: 'Dekko-Regular.ttf',
		category: 'devanagari',
		weight: '400',
		axes: [],
		devanagari: true,
		mood: 'casual handwritten Devanagari',
		useFor: 'informal Nepali vlogs and annotation captions',
	},
	{
		slug: 'halant',
		family: 'Halant',
		source: 'halant',
		file: 'Halant-Bold.ttf',
		category: 'devanagari',
		weight: '700',
		axes: [],
		devanagari: true,
		mood: 'balanced Devanagari serif built for screens',
		useFor: 'Nepali documentary and interview captions',
	},
	{
		slug: 'inknut-antiqua',
		family: 'Inknut Antiqua',
		source: 'inknutantiqua',
		file: 'InknutAntiqua-Bold.ttf',
		category: 'devanagari',
		weight: '700',
		axes: [],
		devanagari: true,
		mood: 'antique Devanagari and Latin book face',
		useFor: 'historical and folklore Nepali storytelling',
	},
	{
		slug: 'palanquin',
		family: 'Palanquin',
		source: 'palanquin',
		file: 'Palanquin-Bold.ttf',
		category: 'devanagari',
		weight: '700',
		axes: [],
		devanagari: true,
		mood: 'light modern Devanagari sans',
		useFor: 'lifestyle and travel Nepali captions',
	},
	{
		slug: 'palanquin-dark',
		family: 'Palanquin Dark',
		source: 'palanquindark',
		file: 'PalanquinDark-Bold.ttf',
		category: 'devanagari',
		weight: '700',
		axes: [],
		devanagari: true,
		mood: 'the heavier Palanquin cut, sized for video',
		useFor: 'Nepali captions that must hold over busy footage',
	},
	{
		slug: 'sarala',
		family: 'Sarala',
		source: 'sarala',
		file: 'Sarala-Bold.ttf',
		category: 'devanagari',
		weight: '700',
		axes: [],
		devanagari: true,
		mood: 'plain, highly legible Devanagari',
		useFor: 'accessibility-first Nepali subtitles',
	},
	{
		slug: 'biryani',
		family: 'Biryani',
		source: 'biryani',
		file: 'Biryani-Bold.ttf',
		category: 'devanagari',
		weight: '700',
		axes: [],
		devanagari: true,
		mood: 'contemporary Devanagari with open counters',
		useFor: 'Nepali food, lifestyle and vlog captions',
	},
	{
		slug: 'cambay',
		family: 'Cambay',
		source: 'cambay',
		file: 'Cambay-Bold.ttf',
		category: 'devanagari',
		weight: '700',
		axes: [],
		devanagari: true,
		mood: 'humanist Devanagari with true italics',
		useFor: 'Nepali educational and explainer captions',
	},
	{
		slug: 'ranga',
		family: 'Ranga',
		...
		axes: [],
		devanagari: true,
		mood: 'playful brush-cut Devanagari display',
		useFor: 'Nepali festival, music and street captions',
	},
	{
		slug: 'tiro-devanagari-marathi',
		family: 'Tiro Devanagari Marathi',
		source: 'tirodevanagarimarathi',
		file: 'TiroDevanagariMarathi-Regular.ttf',
		category: 'devanagari',
		weight: '400',
		axes: [],
		devanagari: true,
		mood: 'calligraphic Devanagari with Marathi letterforms',
		useFor: 'classical Nepali and Marathi titles',
	},
	{
		slug: 'tiro-devanagari-sanskrit',
		family: 'Tiro Devanagari Sanskrit',
		source: 'tirodevanagarisanskrit',
		file: 'TiroDevanagariSanskrit-Regular.ttf',
		category: 'devanagari',
		weight: '400',
		axes: [],
		devanagari: true,
		mood: 'calligraphic Devanagari with Sanskrit conjuncts',
		useFor: 'shloka, mantra and scripture captions',
	},
]
