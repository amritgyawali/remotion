...
To the extent possible under law, the contributors who created these assets
have waived all copyright and related or neighboring rights in them. You may
copy, modify, distribute, perform, and use the assets, including commercially,
...
This dedication applies to the generated audio and catalog only. Source code is
licensed under the repository's main software license.
