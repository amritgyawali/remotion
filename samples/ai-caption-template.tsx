...
export const FONT_KIT = {
	inter: { family: 'Inter', file: 'inter/Inter[opsz,wght].ttf', weight: '100 900', fallback: 'Arial, Helvetica, sans-serif', use: 'UI, explainers, product videos, body copy at any size' },
	archivo: { family: 'Archivo', file: 'archivo/Archivo[wdth,wght].ttf', weight: '100 900', fallback: 'Arial, Helvetica, sans-serif', use: 'headlines that must fit an exact box; condensed captions' },
	montserrat: { family: 'Montserrat', file: 'montserrat/Montserrat[wght].ttf', weight: '100 900', fallback: 'Arial, Helvetica, sans-serif', use: 'brand videos, titles, captions that must feel mainstream' },
	poppins: { family: 'Poppins', file: 'poppins/Poppins-Bold.ttf', weight: '700', fallback: 'Arial, Helvetica, sans-serif', use: 'social captions, product hooks, youthful brands' },
	outfit: { family: 'Outfit', file: 'outfit/Outfit[wght].ttf', weight: '100 900', fallback: 'Arial, Helvetica, sans-serif', use: 'startup explainers, clean lower thirds' },
	sora: { family: 'Sora', file: 'sora/Sora[wght].ttf', weight: '100 800', fallback: 'Arial, Helvetica, sans-serif', use: 'AI and fintech explainers, data storytelling' },
	plusJakartaSans: { family: 'Plus Jakarta Sans', file: 'plus-jakarta-sans/PlusJakartaSans[wght].ttf', weight: '200 800', fallback: 'Arial, Helvetica, sans-serif', use: 'app promos, onboarding, multilingual captions' },
	nunito: { family: 'Nunito', file: 'nunito/Nunito[wght].ttf', weight: '200 1000', fallback: '"Trebuchet MS", Arial, sans-serif', use: 'education, kids, health, onboarding and community videos' },
	fredoka: { family: 'Fredoka', file: 'fredoka/Fredoka[wdth,wght].ttf', weight: '300 700', fallback: '"Trebuchet MS", Arial, sans-serif', use: 'kids content, playful brands, reaction captions' },
	oswald: { family: 'Oswald', file: 'oswald/Oswald[wght].ttf', weight: '200 700', fallback: '"Arial Narrow", Arial, sans-serif', use: 'stat overlays, tickers, documentary captions' },
	bebasNeue: { family: 'Bebas Neue', file: 'bebas-neue/BebasNeue-Regular.ttf', weight: '400', fallback: '"Arial Narrow", Arial, sans-serif', use: 'title cards, lower thirds, trailer-style typography' },
	barlowCondensed: { family: 'Barlow Condensed', file: 'barlow-condensed/BarlowCondensed-Bold.ttf', weight: '700', fallback: '"Arial Narrow", Arial, sans-serif', use: 'dense subtitles, sports scoreboards, tight vertical frames' },
	staatliches: { family: 'Staatliches', file: 'staatliches/Staatliches-Regular.ttf', weight: '400', fallback: '"Arial Narrow", Arial, sans-serif', use: 'event promos, gig posters, hype captions' },
	kanit: { family: 'Kanit', file: 'kanit/Kanit-Bold.ttf', weight: '700', fallback: '"Arial Narrow", Arial, sans-serif', use: 'sports, gym, motivational edits' },
	khand: { family: 'Khand', file: 'khand/Khand-Bold.ttf', weight: '700', fallback: '"Arial Narrow", Arial, sans-serif', use: 'Nepali and Hindi sports or news captions' },
	anton: { family: 'Anton', file: 'anton/Anton-Regular.ttf', weight: '400', fallback: 'Impact, Haettenschweiler, sans-serif', use: 'social hooks, big single-word statements, sports and hype' },
	archivoBlack: { family: 'Archivo Black', file: 'archivo-black/ArchivoBlack-Regular.ttf', weight: '400', fallback: 'Impact, Haettenschweiler, sans-serif', use: 'statement captions, brand stings, callouts' },
	alfaSlabOne: { family: 'Alfa Slab One', file: 'alfa-slab-one/AlfaSlabOne-Regular.ttf', weight: '400', fallback: 'Impact, Haettenschweiler, sans-serif', use: 'retro hooks, sale videos, loud storytelling' },
	titanOne: { family: 'Titan One', file: 'titan-one/TitanOne-Regular.ttf', weight: '400', fallback: 'Impact, Haettenschweiler, sans-serif', use: 'gaming, kids, meme captions' },
	lilitaOne: { family: 'Lilita One', file: 'lilita-one/LilitaOne-Regular.ttf', weight: '400', fallback: 'Impact, Haettenschweiler, sans-serif', use: 'mobile-first captions, quiz and list videos' },
	rowdies: { family: 'Rowdies', file: 'rowdies/Rowdies-Bold.ttf', weight: '700', fallback: 'Impact, Haettenschweiler, sans-serif', use: 'street, music and skate edits' },
	bangers: { family: 'Bangers', file: 'bangers/Bangers-Regular.ttf', weight: '400', fallback: '"Comic Sans MS", Impact, sans-serif', use: 'reaction videos, meme subtitles, action beats' },
	luckiestGuy: { family: 'Luckiest Guy', file: 'luckiest-guy/LuckiestGuy-Regular.ttf', weight: '400', fallback: '"Comic Sans MS", Impact, sans-serif', use: 'kids, gaming, playful hooks' },
	chewy: { family: 'Chewy', file: 'chewy/Chewy-Regular.ttf', weight: '400', fallback: '"Comic Sans MS", Impact, sans-serif', use: 'family content, food, light-hearted captions' },
	bungee: { family: 'Bungee', file: 'bungee/Bungee-Regular.ttf', weight: '400', fallback: 'Impact, Haettenschweiler, sans-serif', use: 'street style, vertical captions, city footage' },
	bungeeShade: { family: 'Bungee Shade', file: 'bungee-shade/BungeeShade-Regular.ttf', weight: '400', fallback: 'Impact, Haettenschweiler, sans-serif', use: 'title cards and one-word hooks that need no effects' },
	rubikMonoOne: { family: 'Rubik Mono One', file: 'rubik-mono-one/RubikMonoOne-Regular.ttf', weight: '400', fallback: 'Impact, Haettenschweiler, sans-serif', use: 'techno, crypto, brutalist edits' },
	shrikhand: { family: 'Shrikhand', file: 'shrikhand/Shrikhand-Regular.ttf', weight: '400', fallback: 'Impact, Haettenschweiler, sans-serif', use: 'food, festival and music captions' },
	playfairDisplay: { family: 'Playfair Display', file: 'playfair-display/PlayfairDisplay[wght].ttf', weight: '400 900', fallback: 'Georgia, "Times New Roman", serif', use: 'fashion, food, real estate, wedding, premium brand films' },
	abrilFatface: { family: 'Abril Fatface', file: 'abril-fatface/AbrilFatface-Regular.ttf', weight: '400', fallback: 'Georgia, "Times New Roman", serif', use: 'editorial hooks, beauty, luxury product' },
	dmSerifDisplay: { family: 'DM Serif Display', file: 'dm-serif-display/DMSerifDisplay-Regular.ttf', weight: '400', fallback: 'Georgia, "Times New Roman", serif', use: 'documentary titles, interviews, premium captions' },
	cinzel: { family: 'Cinzel', file: 'cinzel/Cinzel[wght].ttf', weight: '400 900', fallback: 'Georgia, "Times New Roman", serif', use: 'trailers, history, epic and cinematic titles' },
	spaceGrotesk: { family: 'Space Grotesk', file: 'space-grotesk/SpaceGrotesk[wght].ttf', weight: '300 700', fallback: 'Arial, Helvetica, sans-serif', use: 'developer tools, AI and crypto explainers, launch videos' },
	syne: { family: 'Syne', file: 'syne/Syne[wght].ttf', weight: '400 800', fallback: 'Arial, Helvetica, sans-serif', use: 'design, music and fashion edits' },
	unbounded: { family: 'Unbounded', file: 'unbounded/Unbounded[wght].ttf', weight: '200 900', fallback: 'Arial, Helvetica, sans-serif', use: 'web3, product launches, bold statements' },
	orbitron: { family: 'Orbitron', file: 'orbitron/Orbitron[wght].ttf', weight: '400 900', fallback: 'Arial, Helvetica, sans-serif', use: 'gaming, motorsport, HUD-style captions' },
	audiowide: { family: 'Audiowide', file: 'audiowide/Audiowide-Regular.ttf', weight: '400', fallback: 'Arial, Helvetica, sans-serif', use: 'esports, synthwave, tech reveals' },
	monoton: { family: 'Monoton', file: 'monoton/Monoton-Regular.ttf', weight: '400', fallback: 'Impact, Haettenschweiler, sans-serif', use: 'neon signage looks, music and nightlife' },
	righteous: { family: 'Righteous', file: 'righteous/Righteous-Regular.ttf', weight: '400', fallback: 'Impact, Haettenschweiler, sans-serif', use: 'retro titles, podcasts, lifestyle' },
	pressStart2p: { family: 'Press Start 2P', file: 'press-start-2p/PressStart2P-Regular.ttf', weight: '400', fallback: 'ui-monospace, Consolas, monospace', use: 'retro gaming, speedruns, chiptune edits' },
	silkscreen: { family: 'Silkscreen', file: 'silkscreen/Silkscreen-Regular.ttf', weight: '400', fallback: 'ui-monospace, Consolas, monospace', use: 'UI overlays, glitch aesthetics, HUD labels' },
	vt323: { family: 'VT323', file: 'vt323/VT323-Regular.ttf', weight: '400', fallback: 'ui-monospace, Consolas, monospace', use: 'hacker aesthetics, terminal recordings, horror edits' },
	jetbrainsMono: { family: 'JetBrains Mono', file: 'jetbrains-mono/JetBrainsMono[wght].ttf', weight: '100 800', fallback: 'ui-monospace, Consolas, monospace', use: 'code walkthroughs, labels, timestamps, technical annotation' },
	courierPrime: { family: 'Courier Prime', file: 'courier-prime/CourierPrime-Regular.ttf', weight: '400', fallback: 'ui-monospace, Consolas, monospace', use: 'film scripts, documentary quotes, typewriter reveals' },
	specialElite: { family: 'Special Elite', file: 'special-elite/SpecialElite-Regular.ttf', weight: '400', fallback: 'ui-monospace, Consolas, monospace', use: 'true crime, vintage, found-footage edits' },
	rubikGlitch: { family: 'Rubik Glitch', file: 'rubik-glitch/RubikGlitch-Regular.ttf', weight: '400', fallback: 'Impact, Haettenschweiler, sans-serif', use: 'glitch transitions, error states, horror' },
	rubikWetPaint: { family: 'Rubik Wet Paint', file: 'rubik-wet-paint/RubikWetPaint-Regular.ttf', weight: '400', fallback: 'Impact, Haettenschweiler, sans-serif', use: 'street art, music drops, halloween' },
	caveat: { family: 'Caveat', file: 'caveat/Caveat[wght].ttf', weight: '400 700', fallback: '"Comic Sans MS", cursive', use: 'annotations, circled emphasis, personal notes and vlogs' },
	permanentMarker: { family: 'Permanent Marker', file: 'permanent-marker/PermanentMarker-Regular.ttf', weight: '400', fallback: '"Comic Sans MS", cursive', use: 'callouts, meme captions, whiteboard energy' },
	pacifico: { family: 'Pacifico', file: 'pacifico/Pacifico-Regular.ttf', weight: '400', fallback: '"Brush Script MT", cursive', use: 'travel, food, summer and lifestyle edits' },
	lobster: { family: 'Lobster', file: 'lobster/Lobster-Regular.ttf', weight: '400', fallback: '"Brush Script MT", cursive', use: 'restaurant, retro brand, warm storytelling' },
	sedgwickAve: { family: 'Sedgwick Ave', file: 'sedgwick-ave/SedgwickAve-Regular.ttf', weight: '400', fallback: '"Comic Sans MS", cursive', use: 'hip hop, street culture, skate videos' },
	notoSansDevanagari: { family: 'Noto Sans Devanagari', file: 'noto-sans-devanagari/NotoSansDevanagari[wdth,wght].ttf', weight: '100 900', fallback: '"Mangal", "Kokila", sans-serif', use: 'Nepali and Hindi subtitles, body copy and lower thirds' },
	anekDevanagari: { family: 'Anek Devanagari', file: 'anek-devanagari/AnekDevanagari[wdth,wght].ttf', weight: '100 800', fallback: '"Mangal", "Kokila", sans-serif', use: 'loud Nepali social captions, titles and hooks' },
	notoSerifDevanagari: { family: 'Noto Serif Devanagari', file: 'noto-serif-devanagari/NotoSerifDevanagari[wdth,wght].ttf', weight: '100 900', fallback: '"Mangal", "Kokila", sans-serif', use: 'documentary, literary and news Nepali captions' },
	mukta: { family: 'Mukta', file: 'mukta/Mukta-Bold.ttf', weight: '700', fallback: '"Mangal", "Kokila", sans-serif', use: 'general Nepali and Hindi subtitles at any size' },
	hind: { family: 'Hind', file: 'hind/Hind-Bold.ttf', weight: '700', fallback: '"Mangal", "Kokila", sans-serif', use: 'dense Nepali captions, news tickers' },
	baloo2: { family: 'Baloo 2', file: 'baloo-2/Baloo2[wght].ttf', weight: '400 800', fallback: '"Mangal", "Kokila", sans-serif', use: 'playful Nepali captions, kids and lifestyle' },
	rozhaOne: { family: 'Rozha One', file: 'rozha-one/RozhaOne-Regular.ttf', weight: '400', fallback: '"Mangal", "Kokila", sans-serif', use: 'Nepali film titles, festival and poster captions' },
	yatraOne: { family: 'Yatra One', file: 'yatra-one/YatraOne-Regular.ttf', weight: '400', fallback: '"Mangal", "Kokila", sans-serif', use: 'Nepali music, travel and street content' },
	kalam: { family: 'Kalam', file: 'kalam/Kalam-Bold.ttf', weight: '700', fallback: '"Mangal", "Kokila", sans-serif', use: 'personal vlogs, notes, informal Nepali captions' },
	tiroDevanagariHindi: { family: 'Tiro Devanagari Hindi', file: 'tiro-devanagari-hindi/TiroDevanagariHindi-Regular.ttf', weight: '400', fallback: '"Mangal", "Kokila", sans-serif', use: 'literature, poetry, historical documentary' },
	martelSans: { family: 'Martel Sans', file: 'martel-sans/MartelSans-Bold.ttf', weight: '700', fallback: '"Mangal", "Kokila", sans-serif', use: 'interviews and explainers in Nepali or Hindi' },
	teko: { family: 'Teko', file: 'teko/Teko[wght].ttf', weight: '300 700', fallback: '"Mangal", "Kokila", sans-serif', use: 'Nepali sports, hype and scoreboard captions' },
} as const
...
export const DEVANAGARI_FONT_KIT = {
	khand: { family: 'Khand', file: 'khand/Khand-Bold.ttf', weight: '700', use: 'Nepali and Hindi sports or news captions' },
	notoSansDevanagari: { family: 'Noto Sans Devanagari', file: 'noto-sans-devanagari/NotoSansDevanagari[wdth,wght].ttf', weight: '100 900', use: 'Nepali and Hindi subtitles, body copy and lower thirds' },
	anekDevanagari: { family: 'Anek Devanagari', file: 'anek-devanagari/AnekDevanagari[wdth,wght].ttf', weight: '100 800', use: 'loud Nepali social captions, titles and hooks' },
	notoSerifDevanagari: { family: 'Noto Serif Devanagari', file: 'noto-serif-devanagari/NotoSerifDevanagari[wdth,wght].ttf', weight: '100 900', use: 'documentary, literary and news Nepali captions' },
	mukta: { family: 'Mukta', file: 'mukta/Mukta-Bold.ttf', weight: '700', use: 'general Nepali and Hindi subtitles at any size' },
	hind: { family: 'Hind', file: 'hind/Hind-Bold.ttf', weight: '700', use: 'dense Nepali captions, news tickers' },
	baloo2: { family: 'Baloo 2', file: 'baloo-2/Baloo2[wght].ttf', weight: '400 800', use: 'playful Nepali captions, kids and lifestyle' },
	rozhaOne: { family: 'Rozha One', file: 'rozha-one/RozhaOne-Regular.ttf', weight: '400', use: 'Nepali film titles, festival and poster captions' },
	yatraOne: { family: 'Yatra One', file: 'yatra-one/YatraOne-Regular.ttf', weight: '400', use: 'Nepali music, travel and street content' },
	kalam: { family: 'Kalam', file: 'kalam/Kalam-Bold.ttf', weight: '700', use: 'personal vlogs, notes, informal Nepali captions' },
	tiroDevanagariHindi: { family: 'Tiro Devanagari Hindi', file: 'tiro-devanagari-hindi/TiroDevanagariHindi-Regular.ttf', weight: '400', use: 'literature, poetry, historical documentary' },
	martelSans: { family: 'Martel Sans', file: 'martel-sans/MartelSans-Bold.ttf', weight: '700', use: 'interviews and explainers in Nepali or Hindi' },
	teko: { family: 'Teko', file: 'teko/Teko[wght].ttf', weight: '300 700', use: 'Nepali sports, hype and scoreboard captions' },
} as const
